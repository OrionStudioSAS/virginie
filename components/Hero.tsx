        ...
        <div className="flex-1 space-y-8 text-center md:text-left">
          <div className="reveal reveal-slide-left">
            ...
            <h1 className="text-4xl md:text-6xl font-serif font-bold text-slate-800 leading-tight">
              Retrouvez votre équilibre avec un accompagnementt <span className="text-[#8bc242] underline decoration-[#8bc242]/20 decoration-4 underline-offset-4">personnalisé</span>
            </h1>
          </div>
